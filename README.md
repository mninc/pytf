...
* **custom_session** - A custom requests [session object](https://requests.readthedocs.io/en/latest/user/advanced/#session-objects). Overrides the bypass_cf parameter
